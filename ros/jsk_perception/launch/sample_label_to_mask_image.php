<?php
// file: /tmp/ros_RGD/jsk_recognition/jsk_perception/sample/sample_label_to_mask_image.launch
include_once(dirname(__FILE__)."/../../../RGDcore/RGD.php");
RGD::import('ros/jsk_perception/nodes/image_publisher.php');
RGD::import('ros/jsk_perception/nodes/grid_label.php');
RGD::import('ros/jsk_perception/nodes/label_to_mask_image.php');
